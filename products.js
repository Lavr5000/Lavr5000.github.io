...
window.AI_PRODUCTS = [
  ...
  },
  {
    ...
    cta: { tgText: { ru: "Здравствуйте! Интересует «Калькуляция работ из РД». Прикладываю документацию.",
                     en: "Hi! I'm interested in “Works cost estimate from drawings”. Attaching the drawings." } },
  },
];
